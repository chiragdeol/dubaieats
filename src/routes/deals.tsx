    ...
    <div className="min-h-screen bg-background flex flex-col justify-between text-left">
      <div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-16">
          ...
          {/* Hero Banner */}
          <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-rose-600 rounded-3xl p-8 sm:p-12 text-white shadow-2xl mb-10 relative overflow-hidden">
            <div className="relative z-10 max-w-3xl">
              <div className="inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-md px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider mb-4 border border-white/20">
                <Gift className="w-3.5 h-3.5" /> Dubai Deals & Privilege Cards Hub
              </div>
              ...
              <p className="text-white/90 text-sm sm:text-base leading-relaxed">
                Filter over 50+ luxury restaurants and casual hotspots in Dubai accepting your <strong>Fazaa, Esaad, Emirates Platinum, Entertainer, Supperclub, and UAE Bank cards</strong>.
              </p>
            </div>
          </div>
