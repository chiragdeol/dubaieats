        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-[13px] leading-relaxed text-[#4A4A4A] max-w-md font-normal font-sans">
              Visit Dubai is the official tourism guide to Dubai. From the city's iconic landmarks to vibrant neighbourhoods, world-class shopping and rich cultural experiences, find out all you need to know and plan your trip now.
            </p>
            ...
            <div className="flex items-center gap-4 text-[#1A1A1A]">
              ...
              <a
                ...
                aria-label="Facebook"
                className="p-1.5 rounded-full hover:text-[#D4AF37] hover:scale-110 transition-all"
              >
            ...
            {/* ── APP DOWNLOAD BADGES (Requested by User) ── */}
            <div className="pt-2">
              <p className="text-[11px] font-bold uppercase tracking-wider text-[#757575] font-heading mb-2.5">
                Download the Dubai Eats App
              </p>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#1A1A1A] hover:bg-black text-white px-3.5 py-2 rounded-xl inline-flex items-center gap-2.5 transition-all shadow-xs border border-[#333333] group"
                >
                  <svg className="w-6 h-6 fill-current shrink-0 group-hover:scale-105 transition-transform" viewBox="0 0 24 24">
          ...
          {/* 2. Column: Popular Links (2-3 cols) */}
          <div className="lg:col-span-2 space-y-3.5">
            <h3 className="font-heading font-bold text-sm text-[#1A1A1A] tracking-tight">
              Popular links
            </h3>
          ...
          {/* 3. Column: Helpful Information (2-3 cols) */}
          <div className="lg:col-span-2 space-y-3.5">
            <h3 className="font-heading font-bold text-sm text-[#1A1A1A] tracking-tight">
              Helpful information
            </h3>
          ...
          <div className="lg:col-span-3 space-y-3.5">
            ...
            <ul className="space-y-2.5 text-[13px] text-[#4A4A4A] font-medium font-sans">
              ...
              <li>
                <a href="https://www.dubaitourism.gov.ae" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4AF37] transition-colors">
                  Dubai DET
                </a>
              </li>
              <li>
